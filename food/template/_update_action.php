<?php
    ...
    {{##START LOOP ALL COLUMNS##}}
        {{EXCEPT LIST}}id,insert_time{{END EXCEPT LIST}}    
            if(${{COLUMN_FEILD}} == "")
            {
                header("location:{{TABLE_NAME}}_insert_form.php?action=edit&return={{COLUMN_INDEX}}");
                exit;
            }
    {{##END LOOP ALL COLUMNS##}}
...
<html>
    ...
    <body>
        ...
        <br/>
        <a href="{{TABLE_NAME}}_insert_form.php">กลับหน้าinsert new {{TABLE_NAME}}</a> 
    </body>
</html>
